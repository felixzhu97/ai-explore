...
public class JpaIDocumentRepository implements IDocumentRepository {
    ...
    private final ISpringDataDocumentRepository documentRepository;
    private final ISpringDataChunkRepository chunkRepository;
    private final ObjectMapper objectMapper;

    public JpaIDocumentRepository(ISpringDataDocumentRepository documentRepository,
                                  ISpringDataChunkRepository chunkRepository,
