...
class DtoFactoryMethodTest {
    ...
    class MessageHistoryResponseFactoryTests {
        ...
        @Test
        @DisplayName("should include message details in response")
        void shouldIncludeMessageDetailsInResponse() {
            // Arrange
            ...
            ChatSession session = createTestSessionWithMessages("session-details", "Details", List.of(message));
            ...
            assertThat(response.messages().get(0).text()).isEqualTo("Test message");
