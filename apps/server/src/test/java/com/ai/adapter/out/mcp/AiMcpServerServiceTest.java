...
class AiMcpServerServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new AiMcpServerService(weatherTools, ragSearchTool, aiChatService);
    }
    ...
    class AiChatTests {
        ...
        void shouldReturnAiResponse() {
            ...
            when(aiChatService.chat(message)).thenReturn(expectedResponse);
        ...
        void shouldTruncateLongMessageForLogging() {
            ...
            when(aiChatService.chat(longMessage)).thenReturn(expectedResponse);
